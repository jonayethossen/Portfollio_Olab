...
// আপনার এসেট ফোল্ডার থেকে ক্লায়েন্টের অবতার ইমেজটি ইমপোর্ট করুন
  ...
  return (
    <section className="bg-[#f9f9f9] py-20">
      <Container>
        ...
        {/* এক্সিস্টিং ক্লায়েন্ট কার্ড গ্রিড লেআউট */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-0 max-w-7xl mx-auto mt-8">
          {clients.map((client) => (
            ...
            >
              {/* ১. টপ পার্ট: ক্লায়েন্ট অবতার/ইমেজ */}
              ...
              {/* ২. মিডল পার্ট: হালকা আকাশী ব্যাকগ্রাউন্ডের নাম এরিয়া */}
              ...
              {/* ৩. বটম পার্ট: ক্লায়েন্টের ফিডব্যাক টেক্সট */}
